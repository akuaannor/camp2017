...
<body style="background-color: smokewhite;" data-target=".navbar-fixed-top" onload=''>
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="opacity:1; background-color: rgba(0,0.5,0,0.5); ">
        <!-- <div class="container"> -->
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="">DISTRICT YOUTH CAMPt</a>
            </div>
        ...
        <!-- <div class="container" > -->
          <div class="row" style="margin-top: 20px;">
            <div class="pagetitle col-md-6 col-md-offset-3 col-sm-12 col-xs-12" style="margin-top:40px;">
          ...
          <div class="row">
            <!-- <div class="col-md-12"> -->
            <div class="adduserdiv col-md-6 col-md-offset-3 col-sm-12 col-xs-12" style="padding-top: 40px;">
            <!-- <p style="font-size: 18px; font-weight: bold;">Add User</p> -->
           
              <form id="registration_form" method="post" action="./pages/successfulpage.php" name="registrationform" class="form-group">
                      <div class="col-md-12">    
                            <!-- <h3 style="text-align: center; padding-bottom: 30px; font-weight: bolder;">PERSONAL INFORMATION</h3> -->
                           ...
                           <div class="in col-md-12" >
                            ...
                            <input class="form-control" type="text" name="Surname" id="form_surname"  placeholder="Enter your surname" required="true" style="border: 1px solid #115639;">
                            </div>
                           </div>
                            ...
                            <div class="in col-md-12">
                              ...
                              <div class="input-group">
                               <span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                              <input class="form-control" type="text" name="firstname" id="firstname"  placeholder="First name" required="true" style="border: 1px solid #115639;">
                              </div>
                            </div>
                            ...
                            <div class="in col-md-12">
                              ...
                              <input class="form-control" type="text" name="Othername" id="Othername"  placeholder="Enter other names that you may have" style="border: 1px solid #115639;">
                              </div>
                            </div>

                            <div class="in col-md-6">
                              <label class="form-label" >Date of Birth (or 1999-12-25)</label>
                              <div class="input-group">
                        ...
                        <!--     <div class="col-sm-6" style="height:130px;">
                          ...
                          <script type="text/javascript">
                            ...
                            <div class="in col-md-6">
                              ...
                              <select required="true" name="sex" class="form-control" style="border: 1px solid #115639;">
                            ...
                            <div class="in col-md-12">
                              ...
                              <input required="true" class="form-control" type="text" name="Phonenumber" id="form_phonenumber" onkeypress="return isNumberKey(event)" style="border: 1px solid #115639;">
                              </div>
                            </div>
                            ...
                            <div class="in col-md-12">
                              ...
                              <input required="true" class="form-control" type="email" name="email" id="form_email"  placeholder="Enter your Email" style="border: 1px solid #115639;">
                              </div>
                            </div>
                            ...
                            <div class="in col-md-12">
                              ...
                              <input required="true" class="form-control" type="text" name="Address" placeholder="" style="border: 1px solid #115639;">
                              </div>
                            </div>

                            <div class="in col-md-12">
                              <label for="Nationality">Country</label>
                                  <select required="true" class="form-control" name="nationality">
                            ...
                            <div class="in col-md-12">
                              <label for="filter">Branch</label>
                                  <select class="form-control" name="Assembly" onchange="othefunc(this);">
                                  <option selected="true" disabled="">Branch</option>

                            <?php 
                              $church = $conn->query("SELECT * FROM church");
                              $churches = $church->fetch_assoc();
                              while($churches==true) : ?>
                                    <option value="<?php echo $churches['assembly'];  ?>"><?php echo $churches['assembly'];  ?></option>
                              ...
                              <?php $churches = $church->fetch_assoc();
                                              endwhile 
                                            ?> 
                                            <option value="Other Assembly">Other</option>  
                                  </select>
                            </div>
...
<!--                             <div class="in col-md-6">
                            ...
                            <!-- <div class="form-group col-md-12 col-sm-12">
                              <label class="form-label" for="filter">Test 1 Branch</label>
                              <select  class="form-control" name="Assembly"    id="">
                                        <option selected="true" disabled="">Branch</option>
                                        <option value="Holy Ghost Temple">Holy Ghost Temple</option>
                                        <option value="Yahweh Temple">Yahweh Temple</option>
                                        <option value="Joy Temple">Joy Temple</option>
                            ...
                            <div class="form-group col-md-12 col-sm-12">
                              <label class="form-label" for="filter">Test 2 Assembly/Branch</label>
                              <select  class="form-control" name="Assembly"  onchange="othefunc(this);"  id="">
                                        <option selected="true" disabled="">Branch</option>
                                        <option value="Holy Ghost Temple">Holy Ghost Temple</option>
                                        <option value="Yahweh Temple">Yahweh Temple</option>
                                        <option value="Joy Temple">Joy Temple</option>
                            ...
                            <div class="form-group col-md-12 col-sm-12" id="ifYes" style="display: none;">
                                <label class="form-label" for="church">Church</label> 
                                <input style="z-index: 1;" class="form-control" type="text" id="church" name="church">

                                
                            </div>
                            <script>
                                function othefunc(that) {
                                    if (that.value == "Other Assembly") {
                                        // alert("check");
                            ...
                            <!-- <div class="form-group col-md-12 col-sm-12">
                                    <label class="form-label" for="filter">Assembly/Branch</label>
                        ...
                        <input type="textbox" class="form-control" placeholder="Enter your Assembly" name="other" style="visibility:hidden; margin-top: 10px;"/>           
                            ...
                            <div class="in col-md-12">
                            <label class="form-label">Any Special Health Issues / medications being taken / allegies etc</label>
                            <div class="input-group">
                            ...
                            <div class="in col-md-12">
                            <label class="form-label">Any special diet issues (eg food you don't eat - not dont like)</label>
                          ...
                          <div class="col-md-12" id="inceased">
                            ...
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
                            <input required="true" class="form-control" type="text" name="fam_name" placeholder="" id="ParentsFullName" style="border: 1px solid #115639;">
                            </div>
                            </div>
                            ...
                            <input required="true" class="form-control" type="phone" name="fam_num" placeholder="" style="border: 1px solid #115639;" onkeypress="return isNumberKey(event)">
                            </div>
                            </div>
                            ...
                            <div class="input-group">
                              <span class="input-group-addon"><i class="fa fa-envelope fa" aria-hidden="true"></i></span>
                            <input class="form-control" type="email" name="fam_email" id="fam_email" placeholder="" style="border: 1px solid #115639;">
                            </div>
                            </div>

                          </div>
                            <div class="col-md-12 ">
                            <button class="btn btnlogin" id="Register" type="submit" name="Register">Register</button>
                          </div>
